...
import torch
from eg3d.networks_stylegan2 import Conv2dLayer, SynthesisLayer, ToRGBLayer
from eg3d.torch_utils.ops import upfirdn2d
from eg3d.torch_utils import persistence
from eg3d.torch_utils import misc

from eg3d.networks_stylegan2 import SynthesisBlock
from eg3d.networks_stylegan3 import SynthesisLayer as AFSynthesisLayer
import numpy as np
